...
$(document).ready(function(){
	...
	$("#Add1").click(function(){
		$("#DisplayInsDelUpdate").slideDown();
		$("#StudentDivIns").slideDown();
		$("#StudentDivDel").hide();
		$("#StudentDivUpdate").hide();
		$("#StudentUpdateFill").hide();
	});
